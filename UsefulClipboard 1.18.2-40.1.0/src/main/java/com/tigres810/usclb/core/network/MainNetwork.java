...
public class MainNetwork {
    ...
    public static void init() {
    	SimpleChannel net = NetworkRegistry.ChannelBuilder
                .named(new ResourceLocation(Main.MODID, "network"))
    	...
    	.decoder(UpdateClipboardItem::decode)
    	.encoder(UpdateClipboardItem::encode)
    	.consumer(UpdateClipboardItem::handle)
    	.add();
        
        // Client messages
        
        net.messageBuilder(ClipboardInfo.class, id(), NetworkDirection.PLAY_TO_CLIENT)
        	.decoder(ClipboardInfo::decode)
        	.encoder(ClipboardInfo::encode)
        	.consumer(ClipboardInfo::handle)
        	.add();
    }
